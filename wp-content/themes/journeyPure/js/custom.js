...
jQuery(document).ready(function () {
  ...
  var html = '<a class="mr-btn-wrapper-jp-text hide" href="tel:1-844-505-4799"><div class="mr-btn-wrapper-jp-text-top">Get Help Now!</div><div class="mr-btn-wrapper-jp-text-bottom"><i class="fas fa-phone-alt"></i><span class="call"> Call</span> (844) 505-4799</div></a>'; // if (!jQuery('body').hasClass('page-template-template-virtual-rehab')) {
