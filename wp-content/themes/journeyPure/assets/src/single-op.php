		...
		<div class="container">
			...
			<div class="row">
				<div class="col-12 col-lg-7">
					<div class="embed-responsive embed-responsive-16by9 youtube-video-place" style="background-image: url('<?php echo esc_attr( $op->masthead_youtube_video_thumbnail['url'] ); ?>');" data-yt-url="https://www.youtube.com/embed/<?php echo esc_attr( $op->masthead_youtube_video_id ); ?>">
				...
				<div class="col-12 col-lg-5">
					<div class="jp-op-location-map">
						...
						<div class="jp-op-location-map-embed embed-responsive embed-responsive-16by9">
							<iframe class="iframe-to-load" data-url-value="https://www.google.com/maps/embed/v1/place?key=AIzaSyDwoQ63Mff3mW9-u2fQUhnlMBmX752RKds&q=<?php echo esc_html( $address ); ?>" allowfullscreen></iframe>
						</div>
