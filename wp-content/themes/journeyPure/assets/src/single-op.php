...
<div id="jp-op" class="jp-op">
		...
		<div class="container">
			<div class="row">
				<div class="col-12 col-md-10 offset-md-1 col-lg-8 offset-lg-2">
					<h1 class="jp-op-masthead-h1"><?php echo esc_html( $op->masthead_title ); ?></h1>
					<h2 class="jp-op-masthead-h2"><?php echo esc_html( $op->masthead_subtitle ); ?></h2>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-12 col-md-6 col-lg-5">
					<div class="jp-op-masthead-content">
						...
						<a class="jp-op-masthead-button hide-for-sm" href="tel:844-505-4799" title="Call (844) 505-4799 to talk now."><i class="fas fa-phone"></i> (844) 505-4799</a>
						<a class="jp-op-masthead-button show-for-sm" href="javascript:void(0);" data-toggle="tooltip" data-placement="top" data-trigger="click" title="Call (844) 505-4799 to talk now."><i class="fas fa-phone"></i> (844) 505-4799</a>
					</div>
				</div>
			</div>
		</div>
	...
	<section class="jp-op-section jp-op-highlights">
		<div class="container">
			<div class="row">
				<div class="col-12 col-md-6 col-lg-7">
					<h3 class="jp-op-highlights-h3">Clinic Highlights</h3>

					<ul class="jp-op-highlights-list">
						<li class="jp-op-highlights-list-item">
							<i class="far fa-check-circle jp-op-highlights-list-item-icon"></i>
							<span class="jp-op-highlights-list-item-heading">95% satisfaction rating</span>
							<span class="jp-op-highlights-list-item-text">And, 6000 success stories</span>
						</li>

						<li class="jp-op-highlights-list-item">
							<i class="far fa-check-circle jp-op-highlights-list-item-icon"></i>
							<span class="jp-op-highlights-list-item-heading">Success rates 2x higher than average</span>
							<span class="jp-op-highlights-list-item-text">Compared to data from the National Institute on Drug & Alcohol Abuse</span>
						</li>

						<li class="jp-op-highlights-list-item">
							<i class="far fa-check-circle jp-op-highlights-list-item-icon"></i>
							<span class="jp-op-highlights-list-item-heading">Masters-level+ clinical and medical team</span>
							<span class="jp-op-highlights-list-item-text">Who actually care and put you first</span>
						</li>

						<li class="jp-op-highlights-list-item">
							<i class="far fa-check-circle jp-op-highlights-list-item-icon"></i>
							<span class="jp-op-highlights-list-item-heading">CARF Gold Seal</span>
							<span class="jp-op-highlights-list-item-text">Earned only by the top 20% of centers in the country</span>
						</li>

						<li class="jp-op-highlights-list-item">
							<i class="far fa-check-circle jp-op-highlights-list-item-icon"></i>
							<span class="jp-op-highlights-list-item-heading">In-network with almost every insurance</span>
					...
					<div class="jp-op-highlights-button-wrapper">
						<button type="button" data-toggle="modal" data-target="#main-insurance-form" class="jp-op-highlights-button"><i class="fas fa-id-card"></i> Check Insurance</button>
					</div>
				</div>
