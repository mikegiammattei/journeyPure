			...
			<?php if ( ! isset( $_GET['DEV'] ) ) : ?>
				...
				<script src="<?php echo get_stylesheet_directory_uri() . '/js/vendor.min.js?v=20200722'; ?>"></script>
				<script src="<?php echo get_stylesheet_directory_uri() . '/js/custom.min.js?v=20200722'; ?>"></script>
			<?php endif; ?>
