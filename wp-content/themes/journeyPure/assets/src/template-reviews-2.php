...
<div id="jp-reviews" class="jp-reviews">
	...
	<section class="above-fold">
		<div class="default-container x-loc lazy" style="background-image: url('/wp-content/uploads/2020/07/journeypure-rehab-reviews.jpg')">
													...
													<div class="col-md-6 i-rating">
														<div class="ratings default inline lineup">
															<div class="row no-gutters align-items-center">
																<div class="col-2">
																	<img class="lazy" src="<?php echo esc_attr( $rating->image['sizes']['medium'] ); ?>" alt="<?php echo esc_attr( get_post_meta( $rating->image['ID'], '_wp_attachment_image_alt', true ) ); ?>">
																</div>
					...
					<div class="col-12 col-md-6 order-md-2 col-lg-7 order-lg-2">
						<?php foreach ( $reviews->videos as $video ) : ?>
							<div class="jp-reviews-videos-featured">
								<div class="embed-responsive embed-responsive-16by9 youtube-video-place lazy" style="background-image: url('<?php echo esc_attr( $video['image']['url'] ); ?>')" data-yt-url="https://www.youtube.com/embed/<?php echo esc_attr( $video['youtube_video_id'] ); ?>">
										...
										<div class="col-4 col-md-3">
											<div class="jp-reviews-videos-video">
												<div class="jp-reviews-videos-video-image-wrapper" data-youtube-video-id="<?php echo esc_attr( $video['youtube_video_id'] ); ?>" data-image="<?php echo esc_attr( $video['image']['url'] ); ?>">
													<img class="jp-reviews-videos-video-image lazy" src="<?php echo esc_attr( $video['image']['sizes']['thumbnail'] ); ?>" alt="<?php echo esc_attr( $video['image']['alt'] ); ?>">
