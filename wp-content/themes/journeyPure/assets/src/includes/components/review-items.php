			...
			<div class="row justify-content-between">
				<div class="col-md-9 col-8">
					<div class="row">
						<div class="col-lg-auto col-md-3 col-4 align-self-center">
							<img class="jp-reviews-reviews-review-image lazy" data-src="<?php echo esc_attr( $review->photo['image'] ); ?>" alt="<?php echo esc_attr( $review->photo['alt'] ); ?>">
						</div>
				...
				<?php if ( isset( $review->source_image['image'] ) ) : ?>
					<div class="col-md-3 col-4 align-self-center">
						<img class="jp-reviews-reviews-review-image-google lazy" data-src="<?php echo esc_attr( $review->source_image['image'] ); ?>" alt="<?php echo esc_attr( $_reviews->source_image['alt'] ); ?>">
					</div>
				<?php endif; ?>
			</div>
		</div>
