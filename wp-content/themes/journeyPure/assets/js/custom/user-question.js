...
if($('[data-target="#user-question-form-container"]').length > 0 ||  $('#chat-ctm-btn').length > 0){
	...
	if($(window).outerWidth() > 767){
		$('[data-target="#user-question-form-container"]').add('#chat-ctm-btn').css({'cursor ':'pointer'}).attr('disabled','disabled').attr('data-placement','top').attr('data-html','true').attr('data-trigger', 'click').attr('title', 'Chat feature is having technical issues, but you can text <span>(844) 505-4799</span> to get connected right away.').tooltip('update');
