...
function buddyboss_theme_child_scripts_styles()
{
  ...
  wp_enqueue_style( 'jp-custom-css', get_stylesheet_directory_uri().'/assets/css/jp-style.css', '', '1.0.0' );

  // Javascript
  wp_enqueue_script( 'buddyboss-child-js', get_stylesheet_directory_uri().'/assets/js/custom.js', '', '1.0.0' );
  wp_enqueue_script( 'jp-jquery', 'https://code.jquery.com/jquery-3.4.1.min.js', '', '1.0.0' );
  wp_enqueue_script( 'jp-popper', '//cdnjs.cloudflare.com/ajax/libs/popper.js/1.11.0/umd/popper.min.js', 'jp-jquery', '1.0.0' );
  wp_enqueue_script( 'jp-bootstrap', get_stylesheet_directory_uri().'/assets/js/jp/dist/bootstrap.min.js', 'jp-jquery', '1.0.0' );
  wp_enqueue_script( 'jp-custom-js', get_stylesheet_directory_uri().'/assets/js/jp/dist/main.babel.min.js', '10 ', '1.0.0' );
