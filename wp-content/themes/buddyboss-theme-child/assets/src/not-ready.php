...
$faq_api_call = file_get_contents (SITE_ROOT_URL1() . '/wp-json/wp/v2/faq-api?categories=5');
$faq_api_call = json_decode($faq_api_call);

$faq_ids = array();
foreach ($faq_api_call as $item) {
    $faq_ids[] = $item->id;
}*/
                ...
                <section class="faqs">
                    <div class="container">
                        ...
                        <div class="accordion" id="location-faq-rehab">
                            <?php  foreach ( $faqs as $index => $faq_id) : ?>
                                <div class="card">
                                    <div class="card-header  <?php echo ($index != 0) ? "collapsed" : ""; ?>" data-toggle="collapse" data-target="#l-faq-<?php echo $index; ?>" aria-expanded="true" aria-controls="l-faq-<?php echo $index; ?>" id="l-faq-heading-<?php echo $index; ?>">
                                        <div class="question-box">
                                            ...
                                            <div class="title">
                                                <h5 class="card-title"><?php echo $faq_id->question; ?></h5>
                                            </div>
                                        </div>
                                    </div>
