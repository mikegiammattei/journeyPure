<form class="f-ask-your-question">
    <?php
        $success = false;
        if ( ! empty( $_GET['login-after-question'] ) && $_GET['login-after-question'] == '1' ) {
            $success = true;
        }
        if ( ! empty( $_GET['activation-after-question'] ) && $_GET['activation-after-question'] == '1' ) {
            $success = true;
        }
    ?>
    <div class="bp-feedback success" <?php echo $success ? '' : 'style="display:none;"'; ?>>
