!function(t, e) {
                ...
                if (c._clearMenus(), !e) {
                    ...
                    if (g(t).trigger(i), !i.isDefaultPrevented()) {
                        if (!this._inNavbar) {
                            ...
                            "scrollParent" !== this._config.boundary && g(t).addClass(Ft), this._popper = new u(o, this._menu, this._getPopperConfig());
                        }
    ...
    var Zt = "modal", te = "bs.modal", ee = "." + te, ne = g.fn[Zt], ie = {
        ...
        function o(t, e) {
            this._config = this._getConfig(e), this._element = t, this._dialog = t.querySelector(fe), 
        ...
        return t.toggle = function(t) {
            ...
            this._element.setAttribute("aria-modal", !0), g(this._dialog).hasClass(se) ? this._dialog.querySelector(de).scrollTop = 0 : this._element.scrollTop = 0, 
            ...
            if (this._isShown && this._config.backdrop) {
                if (this._backdrop = document.createElement("div"), this._backdrop.className = le, 
    ...
    var be = "tooltip", Ie = "bs.tooltip", De = "." + Ie, we = g.fn[be], Ae = "bs-tooltip", Ne = new RegExp("(^|\\s)" + Ae + "\\S+", "g"), Oe = [ "sanitize", "whiteList", "sanitizeFn" ], ke = {
        ...
        return t.enable = function() {
            ...
            if (g(this.element).trigger(i), !i.isDefaultPrevented()) {
                ...
                this._activeTrigger[Ke] = !1, this._activeTrigger[Me] = !1, this._activeTrigger[qe] = !1, 
    ...
    var an = "scrollspy", ln = "bs.scrollspy", cn = "." + ln, hn = g.fn[an], un = {
        ...
        return t.refresh = function() {
            ...
            n.hasClass(gn) ? (n.closest(Cn).find(Sn).addClass(_n), n.addClass(_n)) : (n.addClass(_n), 
            n.parents(pn).prev(vn + ", " + En).addClass(_n), n.parents(pn).prev(yn).children(vn).addClass(_n)), 
    ...
    var wn = "bs.tab", An = "." + wn, Nn = g.fn.tab, On = {
        ...
        return t.show = function() {
            ...
            _.reflow(t), t.classList.contains(jn) && t.classList.add(Hn), t.parentNode && g(t.parentNode).hasClass(kn)) {
