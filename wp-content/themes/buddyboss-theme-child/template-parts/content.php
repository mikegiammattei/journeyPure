...
<article id="post-<?php the_ID(); ?>" <?php post_class(array('single-posts')); ?>>
	...
	<div class="entry-content-wrap">
		...
		<?php } else { ?>
			...
			<header class="entry-header <?php echo (get_field('details') ? ' has-details' : ''); ?>">
				<?php
				if ( is_singular() && ! is_related_posts() ) :
                    the_title( '<h1 class="entry-title">', '</h1>' );
...
<?php
get_template_part( 'template-parts/aod','articles' );
