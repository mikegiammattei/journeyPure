...
if ( is_single() && !is_related_posts() && is_singular('post') ) : ?>
	<div class="post-author-info">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <span class="aod-disclaimer" data-toggle="modal" data-target="#aod-author-disclaimer" role="button" >Disclaimer</span>
            </div>
        </div>
		<div class="post-author-details <?php echo $class; ?>">
			...
			<div class="author-desc-wrap">
                ...
                <small class="d-block author-update-date"><i class="fas fa-clock"></i> Last updated:  <?php
